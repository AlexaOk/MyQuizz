 ...
 */
final class Version20180609164242 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_active TINYINT(1) NOT NULL, CHANGE ip ip VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        // $this->addSql('ALTER TABLE user DROP is_active, CHANGE ip ip VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
